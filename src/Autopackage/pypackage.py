...
def distributefile(filepath):
    a = getModulesPath()
    extractFiles(filepath, a) #抽取后的文件会放到testpg目录下


if __name__=="__main__":
    strpath="C:/Users/LEO/Desktop/pykag/"
    if os.path.isdir(strpath) ==True:
        print 'the dir is existing'
    else:
        os.mkdir(strpath)
        print 'create directory '
    distributefile(strpath)
    print 'file have been distribute'
